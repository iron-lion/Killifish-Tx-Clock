...
#Gut
GOBP_allclust_select <- GOBP_allclust_sig %>% filter(cluster == '8')
IDs.bycluster <- c('GO:0044786','GO:0000278','GO:0044770','GO:0006260',#cell cycle
                   'GO:0006281','GO:0038065','GO:0071711','GO:0030198','GO:0001525')
...
GOBP_allclust_go <- GOBP_allclust_go %>% filter(cluster == '8')

### ExtData Fig 5B ###
pdf('Output/Plots/Gut_hClust_GO_bubble_250102.pdf', width = 4, height = 3)
